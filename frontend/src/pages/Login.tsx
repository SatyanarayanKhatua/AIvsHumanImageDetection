...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Welcome back to AI Image Detector!",
    });
        ...
        <div className="w-full max-w-md">
          ...
          >
            <div className="flex justify-center mb-6">
              <div className="w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center animate-pulse-glow">
                <LogIn className="h-8 w-8 text-blue-600" />
              </div>
            </div>
            
            <h1 className="text-2xl font-bold mb-6 text-center gradient-text">Welcome Back</h1>
